...
<head>
    ...
    <title>BurgerHouse - Cadastrar Produto</title>
</head>
<body>
<main>
    ...
    <section class="container-form">
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="container-radio">
                <div>
                    <label for="Hamburguer">Lanche</label>
                    <input type="radio" id="Hamburguer" name="tipo" value="Hambúrguer" checked>
                </div>
                <div>
            ...
            <input type="text" id="valor" name="valor" placeholder="Digite uma descrição" required>
